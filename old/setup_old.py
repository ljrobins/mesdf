    ...
    for path in try_paths:
        ...
        if os.path.exists(macros_path):
            ...
            if not world_ver or not major_ver or not minor_ver:
                ...
                if ver < min_ver:
                    print(
                        "Found unsuitable Eigen version",
                        ver_str,
                        "at",
                        path,
                        "(need >= " + min_ver_str + ")",
...
setup(
    ...
    long_description="Convert triangle mesh to SDF https://github.com/sxyu/sdf. Also includes uniform surface sampling and a ray-casting based software renderer.",
